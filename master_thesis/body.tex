...
\subsubsection{Renderpass and Framebuffer}
...
%A framebuffer is created, based on a specific renderpass.

 %It can only be used with that specific renderpass or a compatible one. Two attachments are compatible if they share their format and samplecount. A renderpass is compatible to another they are the same except for 
