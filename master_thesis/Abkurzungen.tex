...
\newacronym[plural=AABBs,firstplural=axis aligned bounding boxes (AABBs)]{aabb}{AABB}{axis aligned bounding box}
...
\newacronym[plural=BVHs,firstplural=bounding volume hierarchies (BVHs)]{bvh}{BVH}{bounding volume hierarchy}
